function Sources2D_to_simple_mat(file_name, file_path)
    ...
    %save(file_path,'data.mat','A', 'C', 'S', 'C_raw', 'image_size', 'file_name', '-v6')
    str = ["simpler", file_name]
    newStr = char(join(str, '_'))
    save(fullfile(file_path, newStr))
end
